...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function excluir(scriptKey) {
				if (confirm('Tem certeza que deseja excluir este script? Todos as execu&ccedil;&atilde;es associadas a ele ser&atilde;o exclu&iacute;das.')) {
	...
	<body>
		<h1>
			...
			<pronto:icons name="execucao.png" title="Ver Execu&ccedil;&atilde;es" onclick="goTo('${listarExecucoesUrl}')"/>
		</h1>
