	...
	<head>
		...
		<script type="text/javascript">
			...
			function excluir(scriptKey) {
				if (confirm('Tem certeza que deseja excluir este script? Todos as execu&acedil;&oacute;es associadas a ele ser&aatilde;o exclu&iacute;das.')) {
					...
					<table style="width: 100%">
						...
						<c:forEach items="${execucoes}" var="e">
							...
							<tr id="${e.execucaoKey}" class="${cor ? 'odd' : 'even'}">
								...
								<td>
									<pronto:icons name="ver_descricao.png" title="Ver Descri&ccedil;&atilde;o" onclick="verScript(${e.script.scriptKey});"/>
								</td>
								<td>
