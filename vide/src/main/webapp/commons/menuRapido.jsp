	...
	<div style="width: 90%" align="center">
		<div align="right">
			...
			<c:if test="${usuarioLogado.productOwner}">
				<a href="${editarTicketUrl}?backlogKey=2&tipoDeTicketKey=2"><pronto:icons name="nova_estoria.png" title="Incluir Projeto"/></a>
			</c:if>
			<a href="${sprintAtualUrl}"><pronto:icons name="sprint_atual.png" title="Lista de Projetos e Defeitos do Sprint Atual"/></a>
