...
public class UsuarioController {
	...
	public String excluir(final Model model, final String username) throws ProntoException {
		...
		if (quantidade == 1) {
			model.addAttribute("mensagem", "Voc&circ; n&atilde;o pode excluir todos os usu&aacute;rios do Vide !.");
		...
		try {
			...
			model.addAttribute("mensagem", "Usu&aacute;rio excluido com suceso.");
		} catch (final Exception e) {
			model.addAttribute("mensagem", "Este usu&aacute;rio n&atilde;o pode ser excluido porque existem tarefas vinculadas a ele.");
		}
	...
	public String salvar(final Model model, final HttpSession httpSession, final Usuario usuario, final int[] papel, final Integer clienteKey, final String password) throws Exception {
		...
		// atualiza sess�o do usu�rio com os novos pap�is
